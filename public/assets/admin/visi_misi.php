...
if (isset($_SESSION['HAK'])) {
    ...
    <body>
        ...
        <div class="container">
            <div class="col-md-4">
                <!-- <img src="img/KediriLagi.png" class="custom-text-box-image img-fluid" style="align: center;"> -->
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12 text-center mb-4">
                            ...
                            <div class="mb-0" style="text-align: justify; font-size:18px;">
                                ...
                                <center>
                                    <a href="edit_visi_misi.php" type="button" class="btn btn-danger btn-sm">Edit Visi Misi</a>
                                    <a href="edit_kegiatan.php" type="button" class="btn btn-danger btn-sm">Edit Kegiatan Unggulan</a>
                                </center>
                            </div>
                        </div>
