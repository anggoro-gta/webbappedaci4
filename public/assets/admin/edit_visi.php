...
<?php
$id = $_GET['id'];
$query = mysqli_query($koneksi_server, "SELECT * FROM visi_misi WHERE id = $id");
while ($siswa = mysqli_fetch_assoc($query)) :
?>
    <form action="edit_visi_pro.php?id=<?php echo $siswa['id'] ?>" method='POST' enctype="multipart/form-data">
        <div class="container">
            <h2>Update</h2><br>
