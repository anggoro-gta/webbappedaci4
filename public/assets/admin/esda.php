                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-12 text-center mb-4">
                            <h2>BIDANG II EKONOMI DAN SUMBER DAYA ALAM</h2>
                            <center>
                                <a href="edit_esda.php" type="button" class="btn btn-danger btn-sm">Edit</a>
                            </center>
                        </div>
                        <!-- <div class="col-lg-6 col-12"> -->
                        <?php
                        $query = mysqli_query($koneksi_server, "SELECT * FROM bidang_esda");
