                ...
                <div class="table-wrapper">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <a href="add_visi_misi.php" type="button" class="btn btn-danger btn-sm">Add New</a>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_visi.php?id=<?php echo $siswa['id'] ?>">Edit |
                                        </a>
                                        <a href="hapus_visi_misi.php?id=<?php echo $siswa['id'] ?>"> Hapus
                                        </a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
