...
<body>
    <?php
    $id = $_GET['id'];
    $query = mysqli_query($koneksi_server, "SELECT * FROM tugas_fungsi WHERE id = $id");
    while ($siswa = mysqli_fetch_assoc($query)) :
    ?>
        <form action="edit_tugas_pro.php?id=<?php echo $siswa['id'] ?>" method='POST' enctype="multipart/form-data">
            <div class="container">
                <h2>Update</h2><br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="t" name="judul" type="text" class="form-control" value="<?php echo $siswa['judul'] ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
