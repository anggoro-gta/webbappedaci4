...
if (isset($_SESSION['HAK'])) {
    ...
    <body id="section_1">
        ...
        <div class="container">
            <div class="col-md-4">
                <!-- <img src="img/KediriLagi.png" class="custom-text-box-image img-fluid" alt=""> -->
            </div>
            <section class="section-padding" id="section_3">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-12 text-center mb-4">
                            <h2>BIDANG III INFRASTRUKTUR DAN PENGEMBANGAN WILAYAH</h2>
                            <center>
                                <a href="edit_ipw.php" type="button" class="btn btn-danger btn-sm">Edit</a>
                            </center>
                        </div>
                        <!-- <div class="col-lg-6 col-12"> -->
                        <?php
                        $query = mysqli_query($koneksi_server, "SELECT * FROM bidang_ipw");
